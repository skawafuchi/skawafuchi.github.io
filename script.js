		...
		$.ajax({
			...
			success : function(xml){
				...
				if(projectData.find("youtube_url").length){
					$("#media").append('<iframe width="420" height="315" src="http://www.youtube.com/embed/' +projectData.find("youtube_url").text()  + '" style="margin-top:20px;"></iframe><br>');
				}else{
					$("#media").append('<img class="project-image" src="' +projectData.find("urls").find("thumbnail_url").text()+ '" style="margin-top:20px; width:420px; height: 315px;">');
				}
